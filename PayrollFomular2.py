class Employee:
  ...
  # calculate NHIF Contribution
    ...
    def calculate_net_salary(self):
        ...
        net_sal = self.netSalary
        print('net_salaryy7yyyy',net_sal)

        return  net_sal


emp1 = Employee(150000,  0 )
print('Gross Pay',emp1.calculate_gross_salary())
print('NSSF',emp1.nssfContribution)
print('NHIF',emp1.nhifContribution)
print('Taxable income (net pay)',)
print('tax charged',emp1.total_tax_payable)
print('Net salary', emp1.netSalary)